...
internal static class CommandDescriptions
{
    private static readonly Dictionary<string, string> Descriptions = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["$remap"] = "Reload a single map file from disk (map must be empty).",
        ["$shutdown"] = "Announce and perform a graceful server shutdown.",
        ["$undress"] = "Force-unequip everything a player is wearing.",
        ...
        ["$guild"] = "Create a guild with yourself as leader: $guild create <tag> <name> [-- <description>].",
